...
import { Dialog, List, ListItemIcon, ListItem} from '@material-ui/core';
                        ...
                        <div id='editDialog'>
                            ...
                            <div className='createLabel'>
                                ...
                                <div className='inputLabel'>
                                    <input id='input' ref={this.focusInput} onChange={(event)=>{this.changeValue(event)}}
                            ...
                            <div className='createLabel'>
                                ...
                                <div className='inputLabel' >
                                    <input id='inputBefore' onClick={(event)=>{this.handleFocus(event)}} 
                            ...
                            <List>
                                ...
                                <ListItem key={index}>
                                    ...
                                    <input id='inputLabel' defaultValue={item.label_name} className='labelName' />
                                    <ListItemIcon className='rename'>
                                        <svg xmlns="http://www.w3.org/2000/svg" height="18px" width="18px" viewBox="0 0 48 48">
